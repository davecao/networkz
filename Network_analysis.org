...
| 操作                                                | 関数                                                        |
|-----------------------------------------------------+-------------------------------------------------------------|
| $X_{t+1}=X_{t}\bigwedge Y_{t}$                      | $f_{1}(x_1, x2, x3) = x_1 \bigwedge x_2$                    |
| $Y_{t+1}=X_{t}\bigvee Y_{t}$                        | $f_{1}(x_1, x2, x3) = x_1 \bigvee x_2$                      |
| $Z_{t+1}=X_{t}\bigvee (\neg Y_{t} \bigwedge Z_{t})$ | $f_{1}(x_1, x2, x3) = x_1 \bigvee (\neg x_2 \bigwedge x_3)$ |
#+REVEAL_HTML: </div>
